...
function EventFeaturesGrid({ events }: { events: Event[] }) {
              ...
              <div className="flex gap-2">
                ...
                {event.checkoutUrl ? (
                  <Button variant="ghost" asChild>
                    <NextLink href={event.checkoutUrl} target="_blank" rel="noopener noreferrer">
                      Tickets sichern
                    </NextLink>
                  </Button>
                ) : (
...
export function EventsTwoColumnSection({
  events,
  id,
  eyebrow,
  headline,
