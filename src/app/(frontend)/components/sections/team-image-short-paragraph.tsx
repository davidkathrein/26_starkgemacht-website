          ...
          {teamMembers.map((member) => {
            ...
            return (
              <li key={member.id} className="col-span-2">
                ...
                <p className="text-brand-700 dark:text-brand-300 text-base/7">{member.role}</p>
                {member.bio && (
                  <div className="text-brand-600 dark:text-brand-400 mt-4 text-base/7 [&_p]:mb-2 [&_p:last-child]:mb-0">
