      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-20 px-6 lg:px-8 xl:grid-cols-3">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <div className="sticky top-32">
            ...
            <p className="mt-6 text-base/7 text-pretty text-olive-700 dark:text-olive-400">
          ...
          {teamMembers.map((member) => {
            ...
            return (
              <li key={member.id} className="col-span-2">
                ...
                {member.bio && (
                  <div className="mt-4 text-base/7 text-olive-600 dark:text-olive-400 [&_p]:mb-2 [&_p:last-child]:mb-0">
