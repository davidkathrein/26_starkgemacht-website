      ...
      <div className="mx-auto h-full w-full max-w-7xl px-6 py-24 sm:py-32 lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:px-8">
        <div className="max-w-lg">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <Link
              href="/#angebot"
              className="bg-olive-600 hover:bg-olive-500 dark:bg-olive-500 dark:hover:bg-olive-400 rounded-full px-4 py-2.5 text-sm font-semibold text-white shadow-sm"
            >
              Angebote entdecken
            </Link>
            <Link
              href="/"
              className="text-olive-600 dark:text-olive-400 hover:text-olive-500 dark:hover:text-olive-300 text-sm/7 font-semibold"
            >
