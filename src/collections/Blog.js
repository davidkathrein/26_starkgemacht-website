...
exports.Blog = {
    ...
    fields: [
        ...
        (0, payload_1.slugField)({ fieldToUse: 'title' }),
        {
            name: 'excerpt',
            type: 'textarea',
        ...
        },
        {
            ...
            admin: {
                ...
                description: 'Beiträge werden nach diesem Datum sortiert. Ein Beitrag mit einem Datum in der Zukunft wird auf der Website erst ab diesem Zeitpunkt angezeigt.',
            },
        },
    ],
    timestamps: true,
